                        ...
                        <Col span="6" push="8" >
                                <Form :model="formItem"  label-position="top" >
                                    <FormItem label="职工号" size=60px>
                                        ...
                                        <Input v-model="formItem.username" placeholder="Enter something..."  size="large" readonly></Input>
                                    </FormItem>
                                    <FormItem label="姓名">
                                    ...
                                    <Button @click="modal11 = true">修改密码</Button>
                                        ...
                                        <Modal v-model="modal11" width="360">
                                            ...
                                            <div style="text-align:center">
                                                  请输入密码<Input type="password" v-model="password" password /><br>
                                                  请再次输入<Input type="password" v-model="password1" password />
                                            </div>
                                            <div slot="footer">
